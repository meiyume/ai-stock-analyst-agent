...
- ✅ Sector, index, commodity & macro layers (Agent 1.1–1.4)
- ✅ Final technical summary generated by Agent 1 Brain
""")
...
horizon = st.selectbox(
    ...
    options=["Next Day (1D)", "3 Days", "7 Days", "30 Days (1M)"],
    index=2
)
...
if st.button("🔍 Run Technical Analysis"):
    ...
    if "MACD" in df.columns and "MACD_Signal" in df.columns:
        ...
        macd_fig.add_trace(go.Scatter(x=df["Date"], y=df["MACD_Signal"], name="MACD Signal"))
        st.plotly_chart(macd_fig, use_container_width=True)
    else:
        st.warning("⚠️ MACD data is not available for this stock or timeframe.")
    ...
    st.subheader("📌 Final Technical Outlook")
