...
def analyze(ticker, company_name=None, horizon="7 Days", lookback_days=None, api_key=None):
    try:
        ...
        return {
            "summary": f"⚠️ Sector agent failed: {e}",
            "llm_technical_summary": f"Sector agent error: {e}",
            "llm_plain_summary": f"Sector agent error: {e}",
            "llm_summary": f"Sector agent error: {e}",
            "risk_level": "N/A",
            "df": None,
            "chart": None,
        }
